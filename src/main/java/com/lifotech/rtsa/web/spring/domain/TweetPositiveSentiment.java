...
/**
 * This is domain class, which encapsulates attributes related to positive sentiments.
 * 
 * @author SK Singh
 *
 */
public class TweetPositiveSentiment implements Serializable, Comparable<TweetPositiveSentiment> {
	...
	@Override
	public int compareTo(TweetPositiveSentiment other) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TweetPositiveSentiment other = (TweetPositiveSentiment) obj;
